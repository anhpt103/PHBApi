...
{
    [Table("PHA_NHAPDUTOAN_CHUONG_DETAIL")]
    public class PHA_NHAPDUTOAN_CHUONG_DETAIL : DataInfoEntity
    {
        [Column("PHA_NHAPDUTOAN_CHUONG_REFID")]
        [StringLength(50)]
        public string PHA_NHAPDUTOAN_CHUONG_REFID { get; set; }
