namespace BTS.SP.API.ENTITY.Migrations
{
    ...
    public partial class _15012019_EditPHF_BM_09TT_TCDN_ThanhND2th : DbMigration
    {
        public override void Up()
        {
            ...
            AddColumn("BTSTC.PHF_BM_09TT_TCDN", "DTVTN_HACHTOANTHIEU", c => c.String(maxLength: 200));
            AddColumn("BTSTC.PHF_BM_09TT_TCDN", "DTVTN_TANGKHONGDUNG", c => c.String(maxLength: 200));
            AddColumn("BTSTC.PHF_BM_09TT_TCDN", "CP_HACHTOANTHIEU", c => c.String(maxLength: 200));
            AddColumn("BTSTC.PHF_BM_09TT_TCDN", "CP_TANGKHONGDUNG", c => c.String(maxLength: 200));
            AddColumn("BTSTC.PHF_BM_09TT_TCDN", "LNTH_HACHTOANTHIEU", c => c.String(maxLength: 200));
            AddColumn("BTSTC.PHF_BM_09TT_TCDN", "LNTH_TANGKHONGDUNG", c => c.String(maxLength: 200));
        }
