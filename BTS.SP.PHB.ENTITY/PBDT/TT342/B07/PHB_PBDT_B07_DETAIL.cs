...
namespace BTS.SP.PHB.ENTITY.PBDT.B07
{
    [Table("PHB_PBDT_B07_DETAIL")]
    public class PHB_PBDT_B07_DETAIL : BaseEntity
    {
        [Column("PHB_PBDT_B07_REFID")]
        [Required]
        [StringLength(50)]
        public string PHB_PBDT_B07_REFID { get; set; }
