namespace BTS.SP.API.ENTITY.Migrations
{
    ...
    public partial class _20190216_AddTable_TT129_PL01A_PL01B_PL02_TUANDX : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        MADONG = c.String(maxLength: 50),
                        KETQUA_NAMTRUOC = c.Decimal(precision: 18, scale: 2),
                        KEHOACH_NAM = c.Decimal(precision: 18, scale: 2),
                        KETQUA_NAM = c.Decimal(precision: 18, scale: 2),
                        DOICHIEU_NAMTRUOC = c.Decimal(precision: 18, scale: 2),
                        DOICHIEU_KEHOACH = c.Decimal(precision: 18, scale: 2),
