    ...
    public class PHB_L_PC_DTVm
    {
        public class Search : IDataSearch
        {
            ...
            public string DefaultOrder
            {
                get
                {
                    return ClassHelper.GetPropertyName(() => new PHB_L_PC_DT().REFID);
                }
            }
            public List<IQueryFilter> GetFilters()
            {
                var result = new List<IQueryFilter>();
                var refObj = new PHB_L_PC_DT();
        ...
        public class DTO
        {
            public DTO()
            {
                DataDetails = new List<PHB_L_PC_DT_DETAIL>();
                listDeleteDetails = new List<PHB_L_PC_DT_DETAIL>();
            }
            public int ID { get; set; }
            ...
            public DateTime NGAY_SUA { get; set; }
            public string NGUOI_SUA { get; set; }
            public List<PHB_L_PC_DT_DETAIL> DataDetails { get; set; }
            public List<PHB_L_PC_DT_DETAIL> listDeleteDetails { get; set; }
        }
        ...
        public class EditModel
        {
            public int KY_BC { get; set; }
            public string REFID { get; set; }
            public List<PHB_L_PC_DT_DETAIL> LstAdd { get; set; }
            public List<PHB_L_PC_DT_DETAIL> LstEdit { get; set; }
