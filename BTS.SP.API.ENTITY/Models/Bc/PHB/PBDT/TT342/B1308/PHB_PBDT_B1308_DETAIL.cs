...
namespace BTS.SP.API.ENTITY.Models.Bc.PHB.PBDT.B1308
{
    [Table("PHB_PBDT_B1308_DETAIL")]
    public class PHB_PBDT_B1308_DETAIL : DataInfoEntity
    {
        [Column("PHB_PBDT_B1308_REFID")]
        [Required]
        [StringLength(50)]
        public string PHB_PBDT_B1308_REFID { get; set; }
