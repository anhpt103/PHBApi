...
namespace BTS.SP.API.ENTITY.Models.Bc.PHB.PBDT.B1301
{
    [Table("PHB_PBDT_B1301_DETAIL")]
    public class PHB_PBDT_B1301_DETAIL : DataInfoEntity
    {
        [Column("PHB_PBDT_B1301_REFID")]
        [Required]
        [StringLength(50)]
        public string PHB_PBDT_B1301_REFID { get; set; }
