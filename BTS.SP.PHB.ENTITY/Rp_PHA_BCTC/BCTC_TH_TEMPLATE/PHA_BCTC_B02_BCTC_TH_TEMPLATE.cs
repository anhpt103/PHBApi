...
namespace BTS.SP.PHB.ENTITY.Rp_PHA_BCTC.BCTC_TH_TEMPLATE
{
    [Table("PHA_BCTC_B02_BCTC_TH_TEMPLATE")]
    public class PHA_BCTC_B02_BCTC_TH_TEMPLATE : BaseEntity
    {
        [Column("STT_SAPXEP")]
