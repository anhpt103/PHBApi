namespace BTS.SP.API.ENTITY.Migrations
{
    ...
    public partial class _02072019_ADD_PHB_B01_BSTT_2_DUNGNA : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                "BTSTC.PHB_B01_BSTT_2_TEMPLATE",
                c => new
                    {
            ...
            CreateTable(
                "BTSTC.PHB_B01_BSTT_2_DETAIL",
                c => new
                    {
                        ID = c.Decimal(nullable: false, precision: 10, scale: 0, identity: true),
                        PHB_B01_BSTT_2_REFID = c.String(nullable: false, maxLength: 50),
                        STT_SAPXEP = c.Decimal(nullable: false, precision: 10, scale: 0),
                        STT = c.String(maxLength: 5),
                        CHI_TIEU = c.String(nullable: false, maxLength: 250),
                        IS_BOLD = c.Decimal(nullable: false, precision: 10, scale: 0),
                        IS_ITALIC = c.Decimal(nullable: false, precision: 10, scale: 0),
                        NAM_NAY = c.Decimal(precision: 10, scale: 0),
                    })
                .PrimaryKey(t => t.ID);
        ...
        {
            DropTable("BTSTC.PHB_B01_BSTT_2_DETAIL");
            DropTable("BTSTC.PHB_B01_BSTT_2");
            DropTable("BTSTC.PHB_B01_BSTT_2_TEMPLATE");
        }
    }
}
