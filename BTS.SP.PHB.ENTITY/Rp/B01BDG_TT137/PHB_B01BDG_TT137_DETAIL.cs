...
namespace BTS.SP.PHB.ENTITY.Rp.B01BDG_TT137
{
    public class PHB_B01BDG_TT137_DETAIL : BaseEntity
    {
        [Required]
        [Description("Guid ID trong  PHB_B01BDG_TT137")]
        [StringLength(50)]
        public string PHB_B01BDG_TT137_REFID { get; set; }
