namespace BTS.SP.API.ENTITY.Migrations
{
    ...
    public partial class _15012019_DeleteCodePHF_BM_09TT_TCDN_ThanhND2th : DbMigration
    {
        ...
        {
            AddColumn("BTSTC.PHF_BM_09TT_TCDN", "LNTH_TANGKHONGDUNG", c => c.String());
            AddColumn("BTSTC.PHF_BM_09TT_TCDN", "LNTH_HACHTOANTHIEU", c => c.String());
            AddColumn("BTSTC.PHF_BM_09TT_TCDN", "CP_TANGKHONGDUNG", c => c.String());
            AddColumn("BTSTC.PHF_BM_09TT_TCDN", "CP_HACHTOANTHIEU", c => c.String());
            AddColumn("BTSTC.PHF_BM_09TT_TCDN", "DTVTN_TANGKHONGDUNG", c => c.String());
            AddColumn("BTSTC.PHF_BM_09TT_TCDN", "DTVTN_HACHTOANTHIEU", c => c.String());
