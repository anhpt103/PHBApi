...
namespace BTS.SP.PHB.SERVICE.REPORT.PL02_TT137
{
    ...
    public class PL02_TT137ViewModel
    {
        public class AddModel
        {
            public PHB_PL02_TT137 data { get; set; }
            public PHB_PL02_TT137_DETAIL dataDetail { get; set; }
        }
    ...
    public class PL02_TT137ReportViewModel
    {
        //param
