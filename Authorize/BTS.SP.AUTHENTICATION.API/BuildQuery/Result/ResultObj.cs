...
using BTS.SP.AUTHENTICATION.API.BuildQuery.Log;
using BTS.SP.AUTHENTICATION.API.BuildQuery.Message;
using BTS.SP.AUTHENTICATION.API.BuildQuery.Result.Types;
