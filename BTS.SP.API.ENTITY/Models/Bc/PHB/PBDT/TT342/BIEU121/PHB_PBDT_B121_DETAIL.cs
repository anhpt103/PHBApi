...
namespace BTS.SP.API.ENTITY.Models.Bc.PHB.PBDT.BIEU121
{
    [Table("PHB_PBDT_B121_DETAIL")]
    public class PHB_PBDT_B121_DETAIL : DataInfoEntity
    {
        [Column("PHB_PBDT_B121_REFID")]
        [Required]
        [StringLength(50)]
        public string PHB_PBDT_B121_REFID { get; set; }
