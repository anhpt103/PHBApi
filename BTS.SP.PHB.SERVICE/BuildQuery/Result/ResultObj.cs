...
using BTS.SP.PHB.SERVICE.BuildQuery.Log;
using BTS.SP.PHB.SERVICE.BuildQuery.Message;
using BTS.SP.PHB.SERVICE.BuildQuery.Result.Types;

namespace BTS.SP.PHB.SERVICE.BuildQuery.Result
{
