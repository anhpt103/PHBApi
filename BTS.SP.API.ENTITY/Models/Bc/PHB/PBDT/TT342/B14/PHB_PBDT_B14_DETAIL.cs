...
namespace BTS.SP.API.ENTITY.Models.Bc.PHB.PBDT.B14
{
    [Table("PHB_PBDT_B14_DETAIL")]
    public class PHB_PBDT_B14_DETAIL : DataInfoEntity
    {
        [Column("PHB_PBDT_B14_REFID")]
        [Required]
        [StringLength(50)]
        public string PHB_PBDT_B14_REFID { get; set; }
