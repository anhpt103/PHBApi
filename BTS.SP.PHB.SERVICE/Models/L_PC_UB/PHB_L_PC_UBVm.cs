...
namespace BTS.SP.PHB.SERVICE.Models.L_PC_UB
{
    public class PHB_L_PC_UBVm
    {
        public class Search : IDataSearch
        {
            ...
            public string DefaultOrder
            {
                get
                {
                    return ClassHelper.GetPropertyName(() => new PHB_L_PC_UB().REFID);
                }
            }
            public List<IQueryFilter> GetFilters()
            {
                var result = new List<IQueryFilter>();
                var refObj = new PHB_L_PC_UB();
        ...
        public class DTO
        {
            public DTO()
            {
                DataDetails = new List<PHB_L_PC_UB_DETAIL>();
                listDeleteDetails = new List<PHB_L_PC_UB_DETAIL>();
            }
            public int ID { get; set; }
            ...
            public DateTime NGAY_SUA { get; set; }
            public string NGUOI_SUA { get; set; }
            public List<PHB_L_PC_UB_DETAIL> DataDetails { get; set; }
            public List<PHB_L_PC_UB_DETAIL> listDeleteDetails { get; set; }
        }
        ...
        public class EditModel
        {
            public int KY_BC { get; set; }
            public string REFID { get; set; }
            public List<PHB_L_PC_UB_DETAIL> LstAdd { get; set; }
            public List<PHB_L_PC_UB_DETAIL> LstEdit { get; set; }
