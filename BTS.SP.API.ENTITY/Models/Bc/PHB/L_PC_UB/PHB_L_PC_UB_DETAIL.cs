...
namespace BTS.SP.API.ENTITY.Models.Bc.PHB.L_PC_UB
{
    [Table("PHB_L_PC_UB_DETAIL")]
    public class PHB_L_PC_UB_DETAIL : DataInfoEntity
    {
        [Column("MA_BAOCAO_CHA")]
        [StringLength(50)]
        public string MA_BAOCAO_CHA { get; set; }

        [Description("Guid ID trong PHB_L_PC_UB")]
        [StringLength(50)]
