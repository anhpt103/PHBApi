...
{
    [RoutePrefix("api/report/phbB05_TT344")]
    [Route("{id?}")]
    public class PhbB05TT344Controller : ApiController
    {
        private readonly IPHB_PBDT_TT344_B05_Service _bieu01AService;
        private readonly IPHB_PBDT_TT344_B05_DETAIL_Service _bieu01ADetailService;
        private readonly IPHB_PBDT_TT344_B05_TEMPLATE_Service _bieu01ATemplateService;
        private readonly IUnitOfWorkAsync _unitOfWorkAsync;

        public PhbB05TT344Controller(IPHB_PBDT_TT344_B05_Service bieu01AService, IPHB_PBDT_TT344_B05_DETAIL_Service bieu01ADetailService, IPHB_PBDT_TT344_B05_TEMPLATE_Service bieu01ATemplateService, IUnitOfWorkAsync unitOfWorkAsync)
        {
        ...
        public async Task<IHttpActionResult> UploadReportxa()
        {
            ...
            if (httpRequest.Files.Count > 0)
            {
                try
                {
                    ...
                    {
                        var bieu01A = new PHB_PBDT_TT344_B05()
                        {
                        ...
                        if (workSheet != null)
                        {
                            ...
                            for (int r = start_Row; r <= int.MaxValue; r++)
                            {
                                ...
                                {
                                    var obj = new PHB_PBDT_TT344_B05_DETAIL()
                                    {
                                        PHB_PBDT_TT344_B05_REFID = bieu01A.REFID,
                                        ObjectState = ObjectState.Added,
                                        IS_BOLD = 0,
                                        IS_ITALIC = 0,
                                        IS_OPTIONAL = 0,
                                    ...
                                    decimal.TryParse(workSheet.Cells[r, 5].Text.ToString(), out tongso);
                                    obj.UOC_TH_THU = tongso;
                                    tongso = 0;
                                    decimal.TryParse(workSheet.Cells[r, 6].Text.ToString(), out tongso);
                                    obj.UOC_TH_CHI = tongso;
                                    tongso = 0;
                                    decimal.TryParse(workSheet.Cells[r, 7].Text.ToString(), out tongso);
                                    obj.UOC_TH_CHENH_LECH = tongso;
                                    tongso = 0;
                                    decimal.TryParse(workSheet.Cells[r, 8].Text.ToString(), out tongso);
                                    obj.KEHOACH_THU = tongso;
                                    tongso = 0;
                                    decimal.TryParse(workSheet.Cells[r, 9].Text.ToString(), out tongso);
                                    obj.KEHOACH_CHI = tongso;
                                    tongso = 0;
                                    decimal.TryParse(workSheet.Cells[r, 10].Text.ToString(), out tongso);

                                    obj.KEHOACH_CHENH_LECH = tongso;
