...
{
    [Table("PHB_PBDT_QLDT_B02_DETAIL")]
    public class PHB_PBDT_QLDT_B02_DETAIL : DataInfoEntity
    {
        [Column("PHB_PBDT_QLDT_B02_REFID")]
        [Required]
        [StringLength(50)]
        public string PHB_PBDT_QLDT_B02_REFID { get; set; }
        ...
        public decimal? TONG_HESO_PC { get; set; }
