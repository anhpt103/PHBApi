...
namespace BTS.SP.API.ENTITY.Models.Bc.PHB.L_PC_D
{
    [Table("PHB_L_PC_D_DETAIL")]
    public class PHB_L_PC_D_DETAIL : DataInfoEntity
    {
        [Column("MA_BAOCAO_CHA")]
        [StringLength(50)]
        public string MA_BAOCAO_CHA { get; set; }

        [Description("Guid ID trong PHB_L_PC_D")]
        [StringLength(50)]
        public string PHB_L_PC_UB_REFID { get; set; }
