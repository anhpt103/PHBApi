...
namespace BTS.SP.API.ENTITY.Models.Bc.PHB.PBDT.B05
{
    [Table("PHB_PBDT_B05_DETAIL")]
    public class PHB_PBDT_B05_DETAIL : DataInfoEntity
    {
        [Column("PHB_PBDT_B05_REFID")]
        [Required]
        [StringLength(50)]
        public string PHB_PBDT_B05_REFID { get; set; }
