    create or replace PROCEDURE "PHF_PROC_TT129_PL01A" 
(
  P_TUNGAY IN DATE,
  P_DENNGAY IN DATE,
...
BEGIN
    ...
    BEGIN
        ...
        INNER JOIN PHF_TT129_PL01A b ON a.MA_FILE_PK = b.MA_FILE_PK 
        INNER JOIN PHF_TT129_PL01A_TEMPLATE c ON b.MADONG = c.MADONG WHERE a.TENBAOCAO = '''||P_TENBAOCAO||''' AND '||P_WHERE||'
...
FROM
    (
        ...
        INNER JOIN PHF_TT129_PL01A b ON a.MA_FILE_PK = b.MA_FILE_PK 
        INNER JOIN PHF_TT129_PL01A_TEMPLATE c ON b.MADONG = c.MADONG 
