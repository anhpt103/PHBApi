create or replace PROCEDURE PHF_PROC_TT129_PL06
(
  P_TUNGAY IN DATE,
  P_DENNGAY IN DATE,
...
BEGIN
    ...
    BEGIN
        ...
        INNER JOIN PHF_TT129_PL06 b ON a.MA_FILE_PK = b.MA_FILE_PK 
        INNER JOIN PHF_TT129_PL06_TEMPLATE c ON b.MADONG = c.MADONG
    ...
    END;
    QUERRY_SELECT_PIVOT := 'SELECT TEN,SUM(TIEUCHI_PARENT_A) AS TIEUCHI_A,SUM(TIEUCHI_PARENT_B) AS TIEUCHI_B,SUM(TIEUCHI_PARENT_C) AS TIEUCHI_C,SUM(TIEUCHI_PARENT_D) AS TIEUCHI_D,SUM(TIEUCHI_PARENT_E) AS TIEUCHI_E
FROM
    (
