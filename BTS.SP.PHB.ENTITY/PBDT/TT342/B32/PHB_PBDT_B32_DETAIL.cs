...
namespace BTS.SP.PHB.ENTITY.PBDT.B32
{
    [Table("PHB_PBDT_B32_DETAIL")]
    public class PHB_PBDT_B32_DETAIL : BaseEntity
    {
        [Column("PHB_PBDT_B32_REFID")]
        [Required]
        [StringLength(50)]
        public string PHB_PBDT_B32_REFID { get; set; }
