namespace BTS.SP.API.ENTITY.Migrations
{
    ...
    public partial class _29062019_ADD3bangPHA_B03B_BCTC_DUYTB : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                "BTSTC.PHA_B03B_BCTC_DETAIL",
                c => new
                    {
                        ID = c.Decimal(nullable: false, precision: 10, scale: 0, identity: true),
                        PHB_B03B_BCTC_REFID = c.String(nullable: false, maxLength: 50),
        ...
        {
            DropTable("BTSTC.PHA_B03B_BCTC");
            DropTable("BTSTC.PHA_B03B_BCTC_TEMPLATE");
            DropTable("BTSTC.PHA_B03B_BCTC_DETAIL");
        }
    }
}
