create or replace PROCEDURE PHF_PROC_TT129_PL03
(
  P_TUNGAY IN DATE,
  P_DENNGAY IN DATE,
...
BEGIN
    ...
    BEGIN
        ...
        INNER JOIN PHF_TT129_PL03 b ON a.MA_FILE_PK = b.MA_FILE_PK 
        INNER JOIN PHF_TT129_PL03_TEMPLATE c ON b.MADONG = c.MADONG 
    ...
    END;
    QUERRY_SELECT_PIVOT := 'SELECT TEN,SUM(TIEUCHI_PARENT_A) AS TIEUCHI_PARENT_A,SUM(TIEUCHI_PARENT_B) AS TIEUCHI_PARENT_B,SUM(TIEUCHI_PARENT_C) AS TIEUCHI_PARENT_C,SUM(TIEUCHI_PARENT_D) AS TIEUCHI_PARENT_D
FROM
    (
