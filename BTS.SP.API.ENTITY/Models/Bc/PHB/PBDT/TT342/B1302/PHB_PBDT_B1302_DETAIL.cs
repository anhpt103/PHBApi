...
namespace BTS.SP.API.ENTITY.Models.Bc.PHB.PBDT.B1302
{
    [Table("PHB_PBDT_B1302_DETAIL")]
    public class PHB_PBDT_B1302_DETAIL : DataInfoEntity
    {
        [Column("PHB_PBDT_B1302_REFID")]
        [Required]
        [StringLength(50)]
        public string PHB_PBDT_B1302_REFID { get; set; }
