...
namespace BTS.SP.API.ENTITY.Models.Bc.PHB.DUTOANLUONG
{
    public class PHB_DUTOANLUONG : DataInfoEntity
    {
        [Column("REFID")]
        [Required]
        [StringLength(50)]
        ...
        [StringLength(50)]
        public string MA_DV_SDNS { get; set; }

        [StringLength(50)]
        public string MA_SO_SDNS { get; set; }
