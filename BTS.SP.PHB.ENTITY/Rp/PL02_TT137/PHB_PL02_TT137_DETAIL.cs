...
namespace BTS.SP.PHB.ENTITY.Rp.PL02_TT137
{
    [Table("PHB_PL02_TT137_DETAIL")]
    public class PHB_PL02_TT137_DETAIL : BaseEntity
    {
        [Required]
        [Description("Guid ID trong  PHB_PL02_TT137")]
        [StringLength(50)]
        public string PHB_PL02_TT137_REFID { get; set; }
