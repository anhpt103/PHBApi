...
{
    [Table("PHB_PBDT_QLDT_B01_DETAIL")]
    public class PHB_PBDT_QLDT_B01_DETAIL : DataInfoEntity
    {
        [Column("PHB_PBDT_QLDT_B01_REFID")]
        [Required]
        [StringLength(50)]
        public string PHB_PBDT_QLDT_B01_REFID { get; set; }
