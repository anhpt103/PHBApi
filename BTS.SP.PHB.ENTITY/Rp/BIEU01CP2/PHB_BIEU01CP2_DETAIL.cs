...
namespace BTS.SP.PHB.ENTITY.Rp.BIEU01CP2
{
    ...
    public class PHB_BIEU01CP2_DETAIL : BaseEntity
    {
        ...
        [Description("Tổng số: Chênh lệch")]
        public double TS_CHENHLECH { get; set; }
        ...
        [Description("NGân sách trong nước: Chênh lệch")]
        public double NSTN_CHENHLECH { get; set; }
        ...
        [Description("Viện trợ: Chênh lệch")]
        public double VT_CHENHLECH { get; set; }
        ...
        [Description("Vay nợ nhà nước : Chênh lệch")]
        public double VNNN_CHENHLECH { get; set; }
        ...
        [Description("Phiếu được khấu trừ lại : Chênh lệch")]
        public double PDKTL_CHENHLECH { get; set; }
        ...
        [Description("Phiếu được khấu trừ lại : Chênh lệch")]
        public double NHDKDL_CHENHLECH { get; set; }
