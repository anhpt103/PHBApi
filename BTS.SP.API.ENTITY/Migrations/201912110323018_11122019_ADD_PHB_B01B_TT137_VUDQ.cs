namespace BTS.SP.API.ENTITY.Migrations
{
    ...
    public partial class _11122019_ADD_PHB_B01B_TT137_VUDQ : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                "BTSTC.PHB_B01B_TT137_DETAIL",
                c => new
                    {
                        ...
                        SO_DOI_CHIEU = c.Double(nullable: false),
                    })
                .PrimaryKey(t => t.ID);
            
            CreateTable(
                "BTSTC.PHB_B01B_TT137_TEMPLATE",
                c => new
                    {
                        ID = c.Decimal(nullable: false, precision: 10, scale: 0, identity: true),
                        STT = c.Decimal(nullable: false, precision: 10, scale: 0),
        ...
        {
            DropTable("BTSTC.PHB_B01B_TT137");
            DropTable("BTSTC.PHB_B01B_TT137_TEMPLATE");
            DropTable("BTSTC.PHB_B01B_TT137_DETAIL");
        }
    }
}
