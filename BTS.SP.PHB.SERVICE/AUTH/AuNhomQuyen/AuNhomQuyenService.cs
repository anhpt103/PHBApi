...
namespace BTS.SP.PHB.SERVICE.AUTH.AuNhomQuyen
{
    public interface IAuNhomQuyenService : IBaseService<AU_NHOMQUYEN>
    {
        Task<Response<List<SelectObject>>> GetNhomQuyenConfigByUsername(string phanhe, string username);
    }
    public class AuNhomQuyenService : BaseService<AU_NHOMQUYEN>, IAuNhomQuyenService
    {
