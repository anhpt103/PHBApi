...
namespace BTS.SP.API.ENTITY.Models.Bc.PHB.PBDT.BIEU124
{
    [Table("PHB_PBDT_B124_DETAIL")]
    public class PHB_PBDT_B124_DETAIL : DataInfoEntity
    {
        [Column("PHB_PBDT_B124_REFID")]
        [Required]
        [StringLength(50)]
        public string PHB_PBDT_B124_REFID { get; set; }
