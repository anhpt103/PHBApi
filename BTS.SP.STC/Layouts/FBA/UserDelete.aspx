...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserDelete.aspx.cs" Inherits="BTS.SP.STC.Layouts.FBA.UserDelete"
...
<asp:Content ID="Content1" ContentPlaceHolderID="PlaceHolderPageTitle" runat="server">
    <SharePoint:EncodedLiteral ID="PageTitle" Text="DeleteUser_Title"
...
<asp:Content ID="Content3" ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
    <script language="javascript">
        ...
        function confirmDelete() {
            return confirm("<SharePoint:EncodedLiteral runat='server' text='DeleteRoleConfirmText' EncodeMethod='EcmaScriptStringLiteralEncode'/>");
        }
    </script>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    <table border="0" width="100%" cellspacing="0" cellpadding="0" class="ms-descriptiontext">
        <wssuc:InputFormSection runat="server" Title="DeleteConfirmText">
            <template_inputformcontrols>
		    <wssuc:InputFormControl runat="server" LabelText="">
			    <Template_Control>
			        <asp:Label ID="localizedMsg" runat="server" Text="DeleteConfirmText" Visible="false"></asp:Label>
