...
namespace BTS.SP.API.ENTITY.Models.Bc.PHB.PBDT.B1305
{
    [Table("PHB_PBDT_B1305_DETAIL")]
    public class PHB_PBDT_B1305_DETAIL : DataInfoEntity
    {
        [Column("PHB_PBDT_B1305_REFID")]
        [Required]
        [StringLength(50)]
        public string PHB_PBDT_B1305_REFID { get; set; }
