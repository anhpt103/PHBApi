...
namespace BTS.SP.API.ENTITY.Models.Bc.PHB.PBDT.BIEU125
{
    [Table("PHB_PBDT_B125_DETAIL")]
    public class PHB_PBDT_B125_DETAIL : DataInfoEntity
    {
        [Column("PHB_PBDT_B125_REFID")]
        [Required]
        [StringLength(50)]
        public string PHB_PBDT_B125_REFID { get; set; }
