...
{
    public class Repository<TEntity> : IRepositoryAsync<TEntity> where TEntity : Entity, IObjectState
    {
        ...
        //private ClaimObj GetCurrentUser()
        //{
        //    var claimObj = new ClaimObj();
        //    claimObj.Username = HttpContext.Current.User.Identity.Name;
        //    var identity = (ClaimsIdentity)HttpContext.Current.User.Identity;
        //    claimObj.UnitCode = identity.Claims.FirstOrDefault(c => c.Type == "UnitCode").Value;
        //    return claimObj;
        //}
        #endregion
