namespace BTS.SP.API.ENTITY.Migrations
{
    ...
    public partial class _20191210_ADD_2_TABLE_PHB_L_PC_DT_TUANDX : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                "BTSTC.PHB_L_PC_DT_DETAIL",
                c => new
                    {
        ...
        {
            DropTable("BTSTC.PHB_L_PC_DT");
            DropTable("BTSTC.PHB_L_PC_DT_DETAIL");
        }
    }
}
