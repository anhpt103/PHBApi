...
namespace BTS.SP.API.ENTITY.Models.Bc.PHB.PBDT.BIEU123
{
    [Table("PHB_PBDT_B123_DETAIL")]
    public class PHB_PBDT_B123_DETAIL : DataInfoEntity
    {
        [Column("PHB_PBDT_B123_REFID")]
        [Required]
        [StringLength(50)]
        public string PHB_PBDT_B123_REFID { get; set; }
