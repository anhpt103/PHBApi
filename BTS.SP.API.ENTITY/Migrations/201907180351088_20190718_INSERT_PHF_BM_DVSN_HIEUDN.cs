namespace BTS.SP.API.ENTITY.Migrations
{
    ...
    public partial class _20190718_INSERT_PHF_BM_DVSN_HIEUDN : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        NGUYENNHAN = c.String(maxLength: 2000),
                        GHICHU = c.String(maxLength: 2000),
                        I_CREATE_DATE = c.DateTime(),
                        I_CREATE_BY = c.String(maxLength: 50),
                        I_UPDATE_DATE = c.DateTime(),
                ...
                c => new
                    {
                        ...
                        NGUYENNHAN = c.String(maxLength: 2000),
                        TITLE_NGUYENNHAN = c.String(maxLength: 2000),
                        I_CREATE_DATE = c.DateTime(),
                        I_CREATE_BY = c.String(maxLength: 50),
                        I_UPDATE_DATE = c.DateTime(),
                        I_UPDATE_BY = c.String(maxLength: 50),
                ...
                c => new
                    {
                        ...
                        NOIDUNG_CHI = c.String(maxLength: 1000),
                        SOTIEN = c.Decimal(precision: 18, scale: 2),
                        NGUYENNHAN_TRICH_CAOHON = c.String(maxLength: 2000),
                        NGUYENNHAN_TRICH_SAINGUON = c.String(maxLength: 2000),
                        NGUYENNHAN_TRICH_SAI_TYLE = c.String(maxLength: 2000),
                        IS_BOLD = c.Decimal(nullable: false, precision: 10, scale: 0),
                        IS_ITALIC = c.Decimal(nullable: false, precision: 10, scale: 0),
                        I_CREATE_DATE = c.DateTime(),
                        I_CREATE_BY = c.String(maxLength: 50),
