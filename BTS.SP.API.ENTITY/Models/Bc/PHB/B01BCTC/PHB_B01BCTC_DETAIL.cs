...
namespace BTS.SP.API.ENTITY.Models.Bc.PHB.B01BCTC
{
    [Table("PHB_B01BCTC_DETAIL")]
    public class PHB_B01BCTC_DETAIL : DataInfoEntity
    {
        [Column("PHB_B01BCTC_REFID")]
        [Required]
        [Description("Guid ID trong  PHB_B01BCTC")]
        [StringLength(50)]
